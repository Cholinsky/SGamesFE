...
function getIsoDateOnly(value?: string | null) {
  if (!value) {
    return null;
  }
...
function formatAvailabilityLabel(dayDate: string) {
  const date =
    DateTime.fromISO(
      dayDate,
...
function cloneAvailabilityDays(days: Availability[]) {
  return days.map((day) => ({
    ...day,
    selected: false,
    isPreferred: false,
...
export default function PostulacionPage() {
  ...
  const [eventAvailabilityDays, setEventAvailabilityDays] =
